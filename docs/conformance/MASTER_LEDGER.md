...
| I-05 | Route changes announced to assistive technology                                   | §5.4, §12.2 | `not-started` | `components/layout/RouteAnnouncer.tsx`   | Outstanding                                           | —                            |
...
| K-03 | E2E coverage including reduced motion, no-JS readability, and WebGL failure fallback                                                           | §14.1  | `in-progress` | `tests/e2e/`         | 24 e2e tests: desktop, no-JS, reduced-motion all green | —          |
